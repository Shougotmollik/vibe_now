      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              AppLocalizations.of(context).translate('requestSent'),
              style: TextStyle(
                fontSize: 24.sp,
            ...
            SizedBox(height: 8.h),
            Text(
              AppLocalizations.of(context).translate('statusPendingApproval'),
              style: TextStyle(
                  fontSize: 16.sp,
            ...
            Text(
              AppLocalizations.of(context).translate('invitedToRealLifeMeetup'),
