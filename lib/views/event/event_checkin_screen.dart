          ...
          children: [
            ...
            Padding(
              ...
              child: InnerShadowBox(
                ...
                shadowColor: const Color(0xFFC06CFF).withValues(alpha: 0.50),
                blurRadius: 40,
                child: Container(
                  height: 350.h,
                    ...
                    children: [
                      ...
                      GoogleMap(
                        ...
                        onMapCreated: (GoogleMapController controller) {
                          // Apply a custom dark/silver style here if needed
                        },
                      ),
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            gradient: RadialGradient(
                              colors: [
                                const Color(0xFFC06CFF).withValues(alpha: 0.2),
                                Colors.transparent,
                              ],
                            ),
                          ),
                      ...
                      // Custom Marker (Center Fixed)
                      Assets.icons.checkinpin.svg(width: 65.w, height: 65.h),
                    ],
                  ),
                ),
              ),
            ...
            Row(
              ...
              children: [
                ...
                Icon(Icons.favorite, color: Color(0xff_C470F5), size: 20.sp),
              ],
            ),
            Spacer(),
            Padding(
              ...
              child: PrimaryButton.text(
                onPressed: () {
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) => EventCheckOutScreen(),
                    ),
                  );
                },
...
class _InnerShadowPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Draw the full shape filled with shadow color
    final fillPaint = Paint()..color = shadowColor;
    canvas.drawRRect(rrect, fillPaint);

    // Cut out the center using blur + dstOut blend mode
