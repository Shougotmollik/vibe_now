...
// Plan feature keys — mapped to localized strings in translation files
const List<PlanModel> kPlans = [
  PlanModel(
    title: 'Free',
    price: '€0',
    subtitleKey: 'getStartedWithLocalDiscovery',
    hasGradientHeader: false,
    featureKeys: [
      'planFreeWaveCount',
      'planFreeUnlimitedVibes',
      'planFreeJoinCommunities',
      'planFreeCreateCommunity',
      'planFreeMembersPerCommunity',
      'planFreeEventRange',
      'planFreeCreateEvent',
    ],
  ),
  PlanModel(
    title: 'Plus',
    price: '€9.95',
    subtitleKey: 'forActiveMembers',
    isMostPopular: true,
    hasGradientHeader: true,
    isCurrent: true,
    featureKeys: [
      'planPlusWaveCount',
      'planPlusUnlimitedVibes',
      'planPlusJoinCommunities',
      'planPlusCreateCommunities',
      'planPlusMembersPerCommunity',
      'planPlusCreateEvents',
      'planPlusParticipantsPerEvent',
    ],
  ),
  PlanModel(
    title: 'Premium',
    price: '€19.95',
    subtitleKey: 'forOrganizers',
    hasGradientHeader: true,
    featureKeys: [
      'planPremiumUnlimitedWaves',
      'planPremiumUnlimitedVibes',
      'planPremiumJoinUnlimitedCommunities',
      'planPremiumCreateCommunities',
      'planPremiumUnlimitedMembers',
      'planPremiumJoinEventsNoLimit',
      'planPremiumCreateUnlimitedEvents',
      'planPremiumUnlimitedParticipants',
    ],
  ),
];
        ...
        child: Column(
          children: [
            Padding(
              ...
              child: CustomAppBar(title: loc.translate('upgradePlan')),
            ),
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 16.h),
                          ...plan.featureKeys.map((k) => _FeatureRow(textKey: k)),
                          SizedBox(height: 16.h),
      ...
      return Padding(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 4.h),
            Text(
              loc.translate(plan.subtitleKey),
...
class _FeatureRow extends StatelessWidget {
  ...
  const _FeatureRow({required this.textKey});

  @override
  Widget build(BuildContext context) {
    final loc = AppLocalizations.of(context);
    final text = loc.translate(textKey);
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: ElevatedButton(
        ...
        child: Text(
          isFree
              ? loc.translate('subscriptionFree')
              : plan.isCurrent
              ? loc.translate('currentPlan')
